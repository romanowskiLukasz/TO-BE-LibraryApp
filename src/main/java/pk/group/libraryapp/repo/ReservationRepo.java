...
public interface ReservationRepo extends JpaRepository<Reservation, Long> {
    ...
    @Query("SELECT new pk.group.libraryapp.model.AllReservationsModel(r.id,b.title,a.name,r.user.name,r.user.id,b.book_id) from Reservation r join r.book b join  b.authors a")
    List<AllReservationsModel> getAllReservations();
